...
document.getElementById("label3").innerHTML = "Sketch To Be Drawn: " + Element_of_array;
timer_counter = 0;
timer_check = "";
drawn_sketch = "";
answer_holder = "";
...
function check_sketch() {
    ...
    if (timer_counter > 1000) {
        document.getElementById("label1").innerHTML = "Your Sketch: ";
        document.getElementById("label2").innerHTML = "Confidence: ";
        timer_counter = 0;
...
function gotResults(error, results) {
    ...
    document.getElementById("label1").innerHTML = "Your Sketch: " + results[0].label;
